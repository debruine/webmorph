...
By default, WebMorph averages are made with texture on. You can change this default in the Images tab of the Preferences (<span class="cmd">,</span>).
...
By default, WebMorph averages are made with sample contours on. You can change this default in the Images tab of the Preferences (<span class="cmd">,</span>).
...
Click on the folder you want to save the image into and then click the Save button. Add the image name after the folder path. If you add an image extension (.jpg, .png) it will be saved as that file type. If you omit the extension, it will be set to your default extension. You can change this default in the Images tab of the Preferences (<span class="cmd">,</span>).
...
You can then select all your continuum images, choose Moving Gif from the Tools menu, and create an animated image.

<div class="figure">
<img src="images/_movie.gif" alt="Moving Gif."  />
<p class="caption">(\#fig:fig-moving-gif)Moving Gif.</p>
</div>


## 3D

The 3D functions are currently quite basic. You can upload OBJ files and associated BMP or JPEG textures and view them in the delineator. You can also morph between two objects that have the same geometry.
