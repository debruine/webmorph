...
<div id='prefDialog' class='modal' title='Preferences'>
	...
	<table id='prefDialog-3'>
		<tr>
			<td><label for="default_template">Default Template</label></td>
			<td><select id="default_template"></select></td>
		</tr>
		...
		<tr>
			<td><label for="default_line_width">Default Line Width</label></td>
			<td><input id='default_line_width' type='number' step='1' min='1' max='9' value='1' maxlength='1' /></td>
		</tr>
	</table>
</div>
...
<div id='movieDialog' class='modal'>
	...
	<form>
		...
		<div>
			<label for='newfilename'>Movie file name:</label> <input id='newfilename' type='text' style="width: 15em;" />
		</div>
	</form>
