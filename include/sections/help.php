...
<div id='whatsnewDialog' class='modal' title='What&apos;s New?'>
	<dl>
		...
		<ol>
			...
			get appropriate warnings as soon as possible, but I am very busy until mid-December.</li>
		</ol>
		</dd>
...
<div id='help' class='modal' title='WebMorph Help'>
    <div class='prefs'>
	    ...
	    <ul>
    	    <li>Multiscale: Implements multi-scale affine interpolation for image warping.
    	    This is the default, with a good balance between speed and accuracy</li>
			<li>Linear: Implements triangulated linear interpolation for image warping. 
			Linear warping is least accurate, often resulting in image artifacts, but is very fast.</li>
    ...
    <div class='project'>
		...
		<ul>
    		<li>Type a registered name or email address into that project's box in the Owners column.</li>
    		<li>After you type a few characters, a drop-down list of options should appear.</li>
	...
	<div class='finder'>
		...
		<ul>
			...
			<li>You can change the name of a selected folder or file by pressing the Return key</li>
		</ul>
	...
	<div class='delineate'>
		...
		<ul>
			...
			<li>You can move a group of selected points with the mouse or using the arrow keys.</li>
			<li><span class="cmd">-click</span> on a point to select or unselect the whole line.</li>
		...
		<ul>
			...
			point at it). Type the name into the box at the top of the screen and press return.</li>
		</ul>
	</div>
	...
	<div class='average'>
		...
		<ul>
    	    ...
    	    <li>The size of the average will be taken from the first image in the average list.</li>
		</ul>
	</div>
