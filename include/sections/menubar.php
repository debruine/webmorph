<ul id='menubar' data-role="nav-bar">
        ...
        <ul>
            ...
            <?php
                if ($_SESSION['user_id'] == 1) {
                    ...
                    echo "            <li class='finder delineate average transform project' id='reload_scripts'>Reload Scripts</li>\n";
                }
            ?>
    ...
    <li class='menucategory'>
        ...
        <ul>
            ...
            <li class='finder average transform project no-read-only' id='newFolder'>
                New Folder
                <span class="shortcut shiftcmd">N</span>
            </li>
            <li class='finder average transform no-read-only' id='uploadFiles'
                title="Upload image and tem files from your computer">
                Upload
                <span class="shortcut cmd">U</span>
            </li>
            <li class='finder delineate no-read-only' id='webcamPhoto'
                title="Upload an image using your webcam">
                Webcam Upload
                <span class="shortcut shiftcmd">U</span>
            </li>
            ...
            <li class='finder average transform' id='fileListGet'
                ...
                <span class="shortcut cmd">L</span>
            </li>
            <li class='separator'></li>
            <li class='delineate average transform no-read-only' id='save'
                title="Save the delineation or selected image">
                Save
                <span class="shortcut cmd">S</span>
            </li>
            <li class='finder delineate average transform no-read-only' id='deleteItems'>
                Move to Trash
                <span class="shortcut cmd">&#x232b;</span>
            </li>
            <li class='finder average transform no-read-only' id='emptyTrash'>
                Empty Trash...
            </li>
            <li class='separator'></li>
    ...
    <li class='menucategory'>
        ...
        <ul>
            ...
            <li class='separator'></li>
            <li class='finder average transform no-read-only' id='cutItems'>
                Cut
                <span class="shortcut cmd">X</span>
            </li>
            <li class='finder delineate average transform no-read-only' id='copyItems'>
                Copy
                <span class="shortcut cmd">C</span>
            </li>
            <li class='finder delineate average transform no-read-only' id='pasteItems'>
                Paste
    ...
    <li class='menucategory'>
        ...
        <ul>
            ...
            <li class='finder average transform no-read-only' id='mask'
    ...
    <li class='menucategory'>
        <span>Template <code id="currentTem_name"></code></span>
        <ul>
            ...
            <li class='finder no-read-only'>Convert Templates
                ...
                <ul class='submenu' id='convert_template_menu'>
                    ...
                    <li class='finder' data-from='1' data-to='39'>FRL (189) to Scott-GMM (129)</li>
            ...
            <li class='finder average transform no-read-only' id='temFromEmbedded'
                title="Create tem files from embedded tems">
                Tem from Embedded
            </li>
            ...
            <li class='delineate no-read-only' id='autoDelineate'
                title="Automatically delineate using the skybiometry template">
                Auto-Delineate
            ...
            <li class='separator'>
            <li class='delineate no-read-only' id='editTemplate'
                title="Edit the default values for this template or register a new template as a default type">
                New/Edit Template
            </li>
            <li class='delineate no-read-only' id='setPointLabels'
                title="Edit point labels for the default template">
                Set Point Labels
            </li>
            <li class='delineate no-read-only' id='setSymPoints'
