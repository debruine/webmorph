...
THREEx.RendererStats	= function (){
	...
	msDiv.style.cssText = 'padding:6px;text-align:left;background-color:#111;';
	container.appendChild( msDiv );

	var msText	= document.createElement( 'div' );
	msText.style.cssText = 'color:#ff9;font-family:Helvetica,Arial,sans-serif;font-size:12px;line-height:15px';
	...
	for(var i = 0; i < nLines; i++){
		...
		msTexts[i].style.cssText = 'color:#ff9;background-color:#111;font-family:Helvetica,Arial,sans-serif;font-size:12px;line-height:15px';
